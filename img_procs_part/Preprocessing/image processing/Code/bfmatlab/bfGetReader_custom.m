function [r, id] = bfGetReader_custom(varargin)
...
% This function has been modified by MPargett, 10.16.17

%Suppress Information only outputs
%loci.common.Log4jTools.setRootLevel('OFF');
...
% if ~isempty(id), r.setId(id); end  %Id must be set after allocation of reader %***
