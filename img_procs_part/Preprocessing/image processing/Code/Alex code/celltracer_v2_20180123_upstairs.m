...
function [ip, op] = celltracer_v2_20180123_upstairs()
...
fname = '20180123 MCF10A EKAR Fra1 T4  ratio upstairs.nd2';
...
ip.indsz.t  = [206];   %Number of Time points
...
%       (** = Critical for all runs, ++ = Only for objbias)
    ...
    ip.bkmd.exp.Exposure   =   {100, 100, 100, 500};  %Exposure times (ms) ++
    ip.bkmd.exp.ExVolt     =   {10, 14, 14, 40};     %Relative voltage (0-100) ++
...
op.trng     = [1:206];       %Start and End indices of Time to process
